...
while reset:
    ...
    while len(player1_deck) > 0:
        ...
        if card1 > card2: #player won
            print(f"{name} won this round, recieving {points_at_stake} points")
            player_score += points_at_stake
            points_at_stake = 2 
        elif card2 > card1: #computer winning
            print(f"Computer won this time, recieving {points_at_stake} points")
    ...
    player_choice = input("Play again? (y or n) ")
